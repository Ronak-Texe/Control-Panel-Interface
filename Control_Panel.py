...
CRC_Output=CRC_Calculation.CalcRC8(payload_data,len(payload_data))
CRC_Calculation.CompareCRC(CRC_Output,received_data[6])
...
Sensor_Information.SensorInformation(device_number)
